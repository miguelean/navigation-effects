...
export const handleSliderAnimation = (
  ...
  if (!activaImg) {
    if ((idx === 0 && !navigate) || (idx === 7 && navigate))
      return 'duration-[400ms]'
    if ((idx === 1 && !navigate) || (idx === 6 && navigate))
      return 'duration-[500ms]'
    if ((idx === 2 && !navigate) || (idx === 5 && navigate))
      return 'duration-[600ms]'
    if ((idx === 3 && !navigate) || (idx === 4 && navigate))
      return 'duration-[700ms]'
    if ((idx === 4 && !navigate) || (idx === 3 && navigate))
      return 'duration-[800ms]'
    if ((idx === 5 && !navigate) || (idx === 2 && navigate))
      return 'duration-[900ms]'
    if ((idx === 6 && !navigate) || (idx === 1 && navigate))
      return 'duration-[1000ms]'
    if ((idx === 7 && !navigate) || (idx === 0 && navigate))
